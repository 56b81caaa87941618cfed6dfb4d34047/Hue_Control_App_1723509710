...
*/
Vue.component("simple_footer_component_1723509711", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your creativity and bring vibrant colors to life with HueCreator. Explore endless shades, create custom palettes, and make your artistic vision a reality.
                    </div>
                </div>
            </div>
        </footer> 
